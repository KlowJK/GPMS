...
class HoSoService {
  ...
  Uri _byIdUrl(int id) => Uri.parse('$_baseUrl/api/giang-vien/profile');

  // -------- GET profile by id --------
  Future<GiangVienProfile> fetchById({String? bearerToken}) async {
    // dart
    final resp = await http.get(
      Uri.parse('$_baseUrl/api/giang-vien/profile'),
      headers: {
    ...
    return GiangVienProfile.fromJson(result);
  }
