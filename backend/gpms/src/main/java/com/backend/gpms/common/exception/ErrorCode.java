...
public enum ErrorCode {
    ...
    MA_SINH_VIEN_REQUIRED(2051, "Ma sinh vien la bat buoc.", HttpStatus.BAD_REQUEST),
    DE_TAI_ID_REQUIRED(2052, "ID de tai la bat buoc.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_NOT_ASSIGNED(2053, "Chua co giang vien phan bien duoc phan cong.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_LECTURER_EMPTY(2054, "Danh sach giang vien phan bien khong duoc de trong.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_MAX_2_LECTURERS(2055, "Danh sach giang vien phan bien khong duoc qua 2 giang vien.", HttpStatus.BAD_REQUEST),
    INVALID_DE_TAI_ID(2056, "ID de tai khong hop le.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_CANNOT_BE_GVHD(2057, "Giang vien phan bien khong the la giang vien huong dan.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_ALREADY_FULL(2058, "De tai da co day du giang vien phan bien.", HttpStatus.BAD_REQUEST),
    DUPLICATE_LECTURER_IN_REQUEST(2059, "Khong the co giang vien trung lap trong yeu cau.", HttpStatus.BAD_REQUEST),
    LECTURER_ALREADY_ASSIGNED_AS_PB(2060, "Giang vien da duoc phan cong lam giang vien phan bien cho de tai nay.", HttpStatus.BAD_REQUEST),
    DIEM_MIN_0(2061, "Diem phai lon hon hoac bang 0.", HttpStatus.BAD_REQUEST),
    DIEM_MAX_10(2062, "Diem phai nho hon hoac bang 10.", HttpStatus.BAD_REQUEST),
    UNAUTHORIZED_NHAP_DIEM(2063, "Ban khong duoc phep nhap diem cho de tai nay.", HttpStatus.FORBIDDEN),
    PHAN_BIEN_NOT_FOUND(2064, "Phan bien khong ton tai.", HttpStatus.NOT_FOUND),
    THANH_VIEN_HOI_DONG_NOT_FOUND(2065, "Thanh vien hoi dong khong ton tai.", HttpStatus.NOT_FOUND),
    PHAN_BIEN_CHUA_DU(2066, "Can dung 2 điem phan bien de phe duyet.", HttpStatus.BAD_REQUEST),
    HOI_DONG_CHUA_DU(2067, "Can it nhat 5 diem hop le tu hoi dong de phe duyet.", HttpStatus.BAD_REQUEST),
    PHAN_BIEN_CHUA_SANSANG_PHE_DUYET(2068, "Chua tat ca giang vien phan bien san sang de phe duyet.", HttpStatus.BAD_REQUEST),
