...
export default function SubjectPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setItems(extractList<Subject>(s));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-3xl font-semibold text-center mb-8">Quản lý bộ môn</h1>
...
function SubjectModal({
  ...
  onClose: () => void;
  onSubmit: (data: { tenBoMon: string; khoaId: number }) => Promise<any>;
}) {
