import { FileText, CalendarCheck, ClipboardCheck, Building, MessageSquare, Users, UserPlus } from "lucide-react";
...
export default function Dashboard() {
  ...
  {isHead && (
    <>
      <Card to="/lecturers/truong-bo-mon/duyet-de-cuong-cuoi" title="Duyệt đề cương cuối" icon={<FileText className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20" />} color="#0071C6" />
      <Card to="/lecturers/truong-bo-mon/phan-cong-giang-vien" title="Phân công giảng viên" icon={<UserPlus className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20" />} color="#0071C6" />
      <Card to="/lecturers/truong-bo-mon/danh-sach-giang-vien" title="Danh sách giảng viên " icon={<Users className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20" />} color="#0071C6" />
    </>
  )}
